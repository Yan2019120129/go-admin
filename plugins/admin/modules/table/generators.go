...
import (
	...
	"github.com/Yan2019120129/go-admin/modules/collection"
	...
	"github.com/Yan2019120129/go-admin/modules/ui"
	...
	"github.com/Yan2019120129/go-admin/plugins/admin/modules/tools"
	...
	selection "github.com/Yan2019120129/go-admin/template/types/form/select"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "go-admin/modules/db/dialect", Value: "go-admin/modules/db/dialect"},
			{Text: "go-admin/modules/db", Value: "go-admin/modules/db"},
			{Text: "go-admin/modules/language", Value: "go-admin/modules/language"},
			{Text: "go-admin/modules/logger", Value: "go-admin/modules/logger"},
		}).
		FieldDefault("").
